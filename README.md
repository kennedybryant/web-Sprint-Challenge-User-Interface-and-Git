...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
    ...
    Semantic HTML are elements that have names that describe their function.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

    1) display: block places the contents on different lines; display:inline place the contents on the same line.
    2) Because display: block follows a box model, a height and width can be set while display: inline can't.
...
5. Explain why git is valuable to a team of developers.
    ...
    git is a version control system which means that each version of code that is committed is saved, allowing developers to version histories. It allows allows individual team members to have their own branch of work but come together as a team to put a project together.
